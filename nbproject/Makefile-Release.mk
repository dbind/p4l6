...
${OBJECTDIR}/ControladorConsulta.o: ControladorConsulta.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControladorConsulta.o ControladorConsulta.cpp
...
${OBJECTDIR}/ControladorSesion.o: ControladorSesion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControladorSesion.o ControladorSesion.cpp
